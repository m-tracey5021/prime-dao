...
func TestWrite(t *testing.T) {
	...
	sizeWritten, err := dataIO.WriteSizePrefixed(file, toSave)
	...
	_, err = dataIO.WriteSizePrefixed(file, toSave2)
...
func TestRead(t *testing.T) {
	...
	read, err := dataIO.ReadSizePrefixed(file)
	...
	read2, err := dataIO.ReadSizePrefixed(file)
...
func TestUpdate(t *testing.T) {
	...
	sizeUpdated, err := dataIO.Update(file, *toSave)
	if err != nil {
	...
	sizeUpdatedB, err := dataIO.Update(file, *toSaveB)

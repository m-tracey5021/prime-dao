...
// func (dao *Dao[T]) Update(object T) error {

// 	daoIO, err := dao.identifiableIO()
...
// 		if err := daoIO.GoTo(position); err != nil {

// 			return err
// 		}
// 		Occupied, err := daoIO.ReadBool()
...
// 			read, err := daoIO.ReadSizePrefixed()
...
// 				if err := daoIO.GoTo(position + 1); err != nil {

// 					return err
// 				}
// 				if _, err := daoIO.Update(object); err != nil {
...
// func (dao *Dao[T]) Delete(object T) error {
...
// 					return err
// 				}
// 				if err := daoIO.WriteBool(false); err != nil {

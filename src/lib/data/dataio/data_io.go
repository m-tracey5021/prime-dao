...
type DataIO[T any] struct{}

func (dataIO DataIO[T]) WriteSizePrefixed(file *os.File, object T) (int, error) {
...
func (dataIO DataIO[T]) Update(file *os.File, object T) (int, error) {
	...
	if _, err := dataIO.ReadSizePrefixed(file); err != nil {
	...
	if _, err := dataIO.WriteSizePrefixed(file, object); err != nil {
...
func (dataIO DataIO[T]) Delete(file *os.File) (int, error) {
...
func (dataIO DataIO[T]) Zero(file *os.File) error {
